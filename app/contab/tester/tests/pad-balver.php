...
return function(int $remessa, string $entidade, Environment $templates, array &$result): bool {
    ...
    foreach ($itens as $k => $v){
        ...
        $resultado[$cc]['label'] = "$v saldo inicial";
        $resultado[$cc]['valor_manual'] = \contab\tester\get_valor_manual($entidade, $remessa, "{$k}_saldo_inicial");
        $sql = <<<SQL
        ...
        $resultado[$cc]['label'] = "$v saldo final";
        $resultado[$cc]['valor_manual'] = \contab\tester\get_valor_manual($entidade, $remessa, "{$k}_saldo_final");
        $sql = <<<SQL
