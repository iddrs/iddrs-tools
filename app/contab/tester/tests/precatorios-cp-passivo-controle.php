...
return function(int $remessa, string $entidade, Environment $templates, array &$result): bool {
    ...
    $name = 'Precatórios de curto prazo: passivo x controle';
    ...
    $sql = <<<SQL
        ...
        where remessa = $remessa and entidade like '$entidade' 
            and conta_contabil like '2.1.1.1.1.05.%';
    SQL;
    ...
    $sql = <<<SQL
        ...
        from bal_ver 
        where remessa = $remessa and entidade like '$entidade' 
            and conta_contabil like '2.1.3.1.1.06.%';
    SQL;
    $valor = get_value_for_test($sql);
    $etotal += $valor;
    $esquerdo[$sql] = $valor;
    ...
    $sql = <<<SQL
        ...
        from bal_ver 
        where remessa = $remessa and entidade like '$entidade' 
            and conta_contabil like '8.9.9.0.0.01.%';
    SQL;
    $valor = get_value_for_test($sql);
    $dtotal += $valor;
    $direito[$sql] = $valor;
