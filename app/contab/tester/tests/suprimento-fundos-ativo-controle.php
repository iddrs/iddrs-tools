...
return function(int $remessa, string $entidade, Environment $templates, array &$result): bool {
    ...
    $name = 'Suprimento de fundos: ativo x controle';
    ...
    $sql = <<<SQL
        ...
        where remessa = $remessa and entidade like '$entidade' 
            and conta_contabil like '1.1.3.1.1.02.%';
    SQL;
    ...
    $sql = <<<SQL
        ...
        from bal_ver 
        where remessa = $remessa and entidade like '$entidade' 
            and conta_contabil like '8.9.1.2.1.01.%';
    SQL;
    $valor = get_value_for_test($sql);
    $dtotal += $valor;
    $direito[$sql] = $valor;
    ...
    $sql = <<<SQL
        ...
        from bal_ver 
        where remessa = $remessa and entidade like '$entidade' 
            and conta_contabil like '8.9.1.2.1.05.%';
    SQL;
    $valor = get_value_for_test($sql);
    $dtotal += $valor;
    $direito[$sql] = $valor;
